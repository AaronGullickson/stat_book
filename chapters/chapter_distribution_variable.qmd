...
Now that we have the proportions/percents, we can visualize the distribution with a **barplot** in which vertical or horizontal bars give the proportion or percent. @fig-barplot-passclass shows a barplot for the distribution of passengers on the Titanic. 
...
To construct a figure with `ggplot2`, you string together multiple commands with the "+" sign. A very common mistake is to miss a a "+" which will break the chain and end your plot. So, if your plot is not looking right, one of the first things to check is whether you missed a "+" somewhere. 
