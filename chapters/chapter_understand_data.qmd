...
Throuhgout this course, we will use several example datasets. I will use these datasets as examples in the text, in the slides, and in class. You will also access these datasets to complete assignments. More information about these datasets can be found in the Example Datasets section of this textbook, but here I provide a brief overview of each dataset.
