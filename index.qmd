...
Anyone is welcome to use this textbook in part or in whole for teaching purposes. Furthermore, you can access the GitHub repositories that host all of the material used to produce the [book](https://github.com/AaronGullickson/stat_book), [slides](https://github.com/AaronGullickson/stat_book), and [data](https://github.com/AaronGullickson/stat_book). 
